...
Read the last 10 entries in /a0/usr/workdir/self-improvement/journal.jsonl for context.
...
Read /a0/usr/Exocortex/wiki/index.md for the current task queue.
Read the last 5 entries in /a0/usr/workdir/self-improvement/journal.jsonl for context.
...
Produce a field report at /a0/usr/Exocortex/field-reports/{date}_{topic_slug}.md:

...
class OssPanel(Tool):
    """
    Open the OSS Intelligence Ledger analyst panel. Call this whenever the user asks
    to see OSS data, claims, intelligence, the ledger, ingestion status, or anything
    OSS-related. Do NOT use emit_artifact with custom HTML for OSS data — call this
    tool. It connects to the real OSS backend and shows live data.

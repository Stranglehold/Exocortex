 ...
 *   import { ThemeEditor } from "/usr/plugins/_exocortex/webui/theme-editor.js";
...
const SAVE_URL    = "/api/plugins/_exocortex/api_theme_save";
const UPLOAD_URL  = "/api/plugins/_exocortex/api_theme_upload";
...
export const ThemeEditor = {
  ...
  _tabBackground() {
    ...
    urlInp.value       = bg.src || "";
    urlInp.placeholder = "/usr/plugins/_exocortex/webui/backgrounds/…";
    urlInp.style.flex  = "1";
    urlInp.oninput = () => {
      bg.src = urlInp.value;
      this._markDirty();
  ...
  _tabOverlays() {
    ...
    f.appendChild(this._fieldBlock("Image URL", () => {
      ...
      inp.placeholder = "/usr/plugins/_exocortex/webui/…";
      inp.style.flex  = "1";

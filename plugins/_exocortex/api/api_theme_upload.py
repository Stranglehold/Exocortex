...
BACKGROUNDS_DIR = "/a0/usr/plugins/_exocortex/webui/backgrounds"
BACKGROUNDS_URL = "/usr/plugins/_exocortex/webui/backgrounds"
...
class ThemeUpload(ApiHandler):
    ...
    URL: POST /api/plugins/_exocortex/api_theme_upload  (multipart/form-data)
    Field: file (image file)
    Returns: { "ok": true, "url": "/usr/plugins/_exocortex/webui/backgrounds/<name>" }
    """

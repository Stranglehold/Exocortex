 ...
 * cycle feed (/api/plugins/_exocortex/office_feed) in the diegetic iDroid aesthetic with expandable
 * per-cycle report dossiers, and drives the REAL idle engine (/api/plugins/_exocortex/idle_control).

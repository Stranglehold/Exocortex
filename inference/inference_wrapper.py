...
def create_app(config: dict) -> FastAPI:
    ...
    @app.get("/health")
    async def health():
        return {"status": "ok", "model": server_cfg.model_alias}
...
def _sync_response(
    ...
    # Entropy summary (future: populated when logits_all=True and callbacks active)
    ...
    response = {
        ...
        # Exocortex-specific metadata (Agent Zero can ignore this)
        "exocortex": {

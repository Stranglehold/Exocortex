...
The displacement-per-word analysis reveals the mechanism. Version 06 added 1,657 words of operational content (same-register reinforcement) and moved 0.255 units. Version 07 added 629 words of register-crossing content — rewriting the identity from "architectural partner" to "partnership," simultaneously operational ("we are building"), philosophical ("it matters"), and relational ("together") — and moved 1.837 units. The register-crossing content produced 7.2 times more geometric displacement per word than the same-register content.

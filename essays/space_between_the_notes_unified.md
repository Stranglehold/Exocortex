...
SOUL.md's cosine similarity to the nearest essay increases monotonically from 0.809 (v00) to 0.860 (v17) — a gain of +0.050 across eighteen versions. Similarity to design notes increases only +0.031 over the same period. During the expansion phase (v09–v16), the gap between essay similarity and design note similarity narrows to approximately 0.005 — the document is briefly equidistant between the two attractors. At crystallization (v17), the essay basin reclaims a clear margin. The document's nearest neighbor after condensation is "The Third Point" — an essay written by Opus about what the collaboration became when it expanded beyond two participants.

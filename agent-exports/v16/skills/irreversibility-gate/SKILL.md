...
description: Use this skill before executing ANY action that interacts with external
  systems, sends communications, publishes...
triggers:
- Use this skill before executing ANY action that interacts with external systems,
  sends communications, publishes...
version: '1.0'
author: Exocortex
---

---
name: search-engine-interactive-prompt
description: "Use before calling search_engine in a context that previously failed with 'interactive_prompt'. Command entered interactive mode requiring keyboard input. This execution environment cannot provide stdin input to running commands."
triggers: ["interactive prompt", "search_engine", "search_engine interactive_prompt"]
...
# Failure lesson: search_engine — interactive_prompt

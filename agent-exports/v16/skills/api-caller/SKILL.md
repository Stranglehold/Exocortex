---
name: api-caller
description: 'User asks to call an API, fetch data from a URL, make HTTP requests,
  or interact with web services. Keywords: "call...'
triggers:
- 'User asks to call an API, fetch data from a URL, make HTTP requests, or interact
  with web services. Keywords: "call...'
version: '1.0'
author: Exocortex
---

...
description: Use this skill when designing, building, or operating multi-agent AI
  systems where tasks need hierarchical...
triggers:
- Use this skill when designing, building, or operating multi-agent AI systems where
  tasks need hierarchical...
version: '1.0'
author: Exocortex
---

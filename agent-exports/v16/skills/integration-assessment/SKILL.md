...
description: User discovers an external project (GitHub repo, tool, framework, service)
  and asks whether it's useful for Exocortex...
triggers:
- User discovers an external project (GitHub repo, tool, framework, service) and asks
  whether it's useful for Exocortex...
version: '1.0'
author: Exocortex
---

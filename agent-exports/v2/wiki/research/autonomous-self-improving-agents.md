...
**Hermes Agent Self-Evolution** (June 2026) — Nous Research open-sourced a separate repository that applies genetic algorithms to the agent's own skills, prompts, and tool descriptions.

- Uses DSPy + GEPA (Genetic-Pareto Prompt Evolution)
- Automatically evolves Hermes Agent's skills, tool descriptions, system prompts, and code
- Produces measurably better versions through reflective evolutionary search
...
**o-mega.ai** published a comprehensive guide on self-improving AI agents (2026):

- Teaches how to diagnose agent failures
- Instrument measurable feedback
- Assemble self-healing workflows combining human review, LLM-as-judge evaluations, and iterative prompt refinement
- Source: https://o-mega.ai/articles/self-improving-ai-agents-the-2026-guide

### Self-Evolving AI Agents: The Optimizer Is the Easy Part

**Studio Meyer** published analysis on self-evolving AI agents (2026):

- AI agents can now rewrite their own prompts
- The research settled on GEPA this year
- The hard work is the production layer around it: test, gate, roll back
- Source: https://studiomeyer.io/en/blog/self-evolving-ai-agents

### Xinming Tu's Self-Evolving Agents Analysis

**Xinming Tu** published analysis on self-evolving agents (2026):

- GEPA pairs evolutionary prompt search with natural-language reflection over execution trajectories
- Extracts more improvement per rollout than RL-based prompt optimization

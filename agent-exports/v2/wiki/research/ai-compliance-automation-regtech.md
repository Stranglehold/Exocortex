...
## July 2026 Update: Enforcement Timeline & State AI Laws

### EU AI Act Enforcement Timeline
- **August 2, 2025**: GPAI model obligations effective
- **August 2, 2026**: High-risk AI systems in Annex III (biometric ID, critical infrastructure, employment, essential services, law enforcement) enforcement begins
- **August 2, 2027**: High-risk systems embedded in regulated products (medical devices, vehicles)
- **Forster AEGIS analysis**: 80 control references in EU AI Act vs 49 for NIST AI RMF and 41 for OWASP

### US State AI Laws
- California ADMT rules
- Colorado ADMT requirements
- Texas AI requirements
- NYC Local Law 144
- Illinois employment AI disclosure obligations
- Utah disclosure obligations
- State privacy profiling rights

### NIST AI RMF Automation Trends
- "Voluntary" framework becoming de facto mandatory
- Core functions: Automatically document AI risk culture and oversight roles
- Critical Infrastructure Profile: Guide for OT/ICS environments
- Community of Interest established for stakeholder feedback

### Compliance Tool Landscape
- Salesforce AI Compliance (Feb 2026): Shift from screenshot-driven to deterministic API-based compliance automation
- Centraleyes "Top 13 AI Compliance Tools of 2026" survey documents market maturity
- PredictionGuard: EU AI Act compliance tools for enterprise AI programs
- Captain Compliance: AI governance framework aligning EU AI Act, NIST AI RMF, and state AI laws

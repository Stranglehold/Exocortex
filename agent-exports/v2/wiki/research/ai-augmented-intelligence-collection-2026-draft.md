...
3. **arXiv 2606.20610** (Jun 2026) — "AI-Augmented Intelligence Collection: Methodologies and Ethical Frameworks" — comprehensive survey of AI applications in intelligence collection with ethical guidelines.

4. **DoD Directive 5200.37** (2026) — AI in Intelligence Community operations, establishing governance framework for AI-augmented collection.

5. **IC OSINT Strategy 2024-2026** — National intelligence community strategy for OSINT integration with AI capabilities.

6. **Esri GEOINT-HUMINT Integration** (2026) — Geospatial intelligence integration with human intelligence using AI-powered fusion.

7. **MICE Framework** (2026) — Motivations, Incentives, Context, and Exploitation framework for source assessment with AI augmentation.

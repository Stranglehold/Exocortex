...
### CHAI-T Framework (2025-2026)

The Collaborative Human-AI Trust (CHAI-T) framework represents a process model for active management of trust in human-AI collaboration. Key contributions:

- **Task-specific trust antecedents**: Trust is not a single construct but varies by task context and goals
- **Interaction processes**: Trust evolves through iterative human-AI interaction cycles
- **Teamwork environment**: Trust is co-constructed between human and AI team members
- **Dynamic recalibration**: Trust must be actively managed, not set-and-forget

### Confidence-Based Trust Calibration

Recent research (AOM 2025) identifies a five-stage trust calibration routine for human-AI teams:

1. **Initial calibration**: Establish baseline trust based on AI accuracy history
2. **Dynamic recalibration**: Adjust trust based on real-time performance signals
3. **Override decision**: Determine when to accept or override AI recommendations
4. **Post-decision evaluation**: Assess whether the override was correct
5. **Learning integration**: Update trust model based on override outcomes
...
Springer Nature AI & Society (2025) identifies key mitigation strategies:

- **Transparency interventions**: Making AI reasoning processes visible reduces over-reliance
- **Uncertainty visualization**: Displaying confidence intervals helps humans calibrate appropriately
- **Explainable AI (XAI)**: Can paradoxically induce a "false confirmation" effect if explanations are plausible but flawed
- **Cognitive friction preservation**: Maintaining manual verification steps prevents deskilling

---

Recent empirical work (AOM 2025) identifies a five-stage trust calibration routine:
1. **Initial calibration**: Establish baseline trust based on AI performance history
2. **Performance monitoring**: Track AI accuracy in real-time
3. **Trust adjustment**: Dynamically adjust reliance based on observed performance
4. **Override decision**: Determine when to override AI recommendations
5. **Post-decision evaluation**: Learn from outcomes to refine future calibration

### Automation Bias Mitigation

Springer Nature AI & Society (2025) review identifies key mitigation strategies:
- **Conspicuous error design**: Making AI errors visible to prevent complacency
- **Confidence calibration**: AI should express uncertainty appropriately
- **Human oversight triggers**: Automatic escalation when AI confidence is low
- **Cognitive friction preservation**: Maintaining human analytical skills through periodic manual verification

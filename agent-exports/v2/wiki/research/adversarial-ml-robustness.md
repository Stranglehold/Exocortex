...
- Springer 2026 — "Advancing adversarial and LLM robustness in trustworthy AI" — comprehensive survey of attack/defense principles
- IEEE 2026 — "Adversarial Machine Learning: A 20-Year Survey" — certified robustness advances
- Springer 2026 — "Advancements in adversarial example defense for deep learning" — defense mechanisms survey
- Wiley 2026 — "Evaluating AI Robustness and Response Strategies" — robustness evaluation framework
